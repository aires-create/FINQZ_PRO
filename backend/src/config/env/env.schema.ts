...
export const rawEnvSchema = z.object({
  ...
  SOS_BOLSO_MARGIN_PATH: optionalEnvString,
  SOS_BOLSO_CLIENT_ID: optionalEnvString,
  SOS_BOLSO_CLIENT_SECRET: optionalEnvString,
  SOS_BOLSO_TIMEOUT_MS: optionalEnvString,
  SOS_BOLSO_SIGNED_JWT: optionalEnvString,
  BLUEPAY_ENABLED: optionalEnvString,
  BLUEPAY_BASE_URL: optionalEnvString,
